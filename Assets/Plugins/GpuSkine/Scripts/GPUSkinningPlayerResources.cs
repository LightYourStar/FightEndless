...
public class GPUSkinningPlayerResources
{
    ...
    private Vector4 MColor = Vector4.zero;
    ...
    private GPUSkinningBetterList<BoundingSphere> cullingBounds = null;
    ...
    private static string _GPUSkinning_TextureMatrix = "_GPUSkinning_TextureMatrix";
    private static string _GPUSkinning_TextureSize_NumPixelsPerFrame = "_GPUSkinning_TextureSize_NumPixelsPerFrame";
    private static string _GPUSkinning_FrameIndex_PixelSegmentation = "_GPUSkinning_FrameIndex_PixelSegmentation";
    private static string _GPUSkinning_FrameIndex_PixelFuryColor = "_GPUSkinning_FrameIndex_PixelFuryColor";
    private static string _GPUSkinning_FrameIndex_PixelLightDir = "_GPUSkinning_FrameIndex_PixelLightDir";
    private static string _GPUSkinning_RootMotion = "_GPUSkinning_RootMotion";
    private static string _GPUSkinning_FrameIndex_PixelSegmentation_Blend_CrossFade = "_GPUSkinning_FrameIndex_PixelSegmentation_Blend_CrossFade";
    private static string _GPUSkinning_RootMotion_CrossFade = "_GPUSkinning_RootMotion_CrossFade";
    ...
    private static int shaderPorpID_GPUSkinning_FrameIndex_PixelFuryColor = 0;

    private static int shaderPorpID_GPUSkinning_FrameIndex_PixelLightDir = 0;
    ...
    public GPUSkinningPlayerResources()
    {
        if (shaderPropID_GPUSkinning_TextureMatrix == -1)
        {
            ...
            shaderPorpID_GPUSkinning_FrameIndex_PixelFuryColor = Shader.PropertyToID(_GPUSkinning_FrameIndex_PixelFuryColor);
            shaderPorpID_GPUSkinning_FrameIndex_PixelLightDir = Shader.PropertyToID(_GPUSkinning_FrameIndex_PixelLightDir);
    ...
    {
        mpb.SetVector(shaderPorpID_GPUSkinning_FrameIndex_PixelFuryColor,MColor);
        mpb.SetVector(shaderPorpID_GPUSkinning_FrameIndex_PixelLightDir, LightDir);
    ...
    public void InitMaterial(Material originalMaterial, HideFlags hideFlags)
    {
        ...
        for (int i = 0; i < mtrls.Length; ++i)
        {
            ...
            {
                mtrls[i] = new GPUSkinningMaterial() { material = originalMaterial };
            }
            else
            {
